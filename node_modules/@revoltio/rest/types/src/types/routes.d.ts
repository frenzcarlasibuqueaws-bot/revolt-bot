export declare type Routes = {
    ...
    response: {
        ...
        relationship?: ('None' | 'User' | 'Friend' | 'Outgoing' | 'Incoming' | 'Blocked' | 'BlockedOther') | null;
        online?: boolean | null;
    };
} | {
    path: `/users/@me`;
...
export declare type GetRoutes = Extract<Routes, {
    method: 'GET';
}>;
export declare type DeleteRoutes = Extract<Routes, {
    method: 'DELETE';
}>;
export declare type PostRoutes = Extract<Routes, {
    method: 'POST';
}>;
export declare type PatchRoutes = Extract<Routes, {
    method: 'PATCH';
}>;
export declare type PutRoutes = Extract<Routes, {
    method: 'PUT';
}>;
