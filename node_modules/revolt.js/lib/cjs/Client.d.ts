...
import { Channel, Emoji, Message, Server, ServerMember, User } from "./classes/index.js";
...
import { HydratedChannel, HydratedEmoji, HydratedMessage, HydratedServer, HydratedServerMember, HydratedUser } from "./hydration/index.js";
export type Session = {
    _id: string;
    token: string;
    user_id: string;
