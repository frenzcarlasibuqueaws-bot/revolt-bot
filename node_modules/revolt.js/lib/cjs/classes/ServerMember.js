...
class ServerMember {
    ...
    getPermissions(target) {
        return (0, calculator_js_1.calculatePermission)(__classPrivateFieldGet(this, _ServerMember_collection, "f").client, target, {
            member: this,
        });
    }
    /**
    ...
    hasPermission(target, ...permission) {
        return (0, calculator_js_1.bitwiseAndEq)(this.getPermissions(target), ...permission.map((x) => definitions_js_1.Permission[x]));
    }
    /**
