import type { DataEditChannel, DataMessageSearch, DataMessageSend, Override } from "revolt-api";
...
export declare class Channel {
     ...
     * Channel icon
     */
    get icon(): import("./File.js").File | undefined;
    /**
     ...
     */
    get typing(): import("./User.js").User[];
    /**
     ...
     */
    get recipients(): import("./User.js").User[];
    /**
     * Find recipient of this DM
     */
    get recipient(): import("./User.js").User | undefined;
    /**
     * User ID
     */
    get userId(): string;
     ...
     */
    get user(): import("./User.js").User | undefined;
    /**
     * Owner ID
     */
    get ownerId(): string;
     ...
     * Owner of the group
     */
    get owner(): import("./User.js").User | undefined;
    /**
     * Server ID
     */
    get serverId(): string;
     ...
     */
    fetchMembers(): Promise<import("./User.js").User[]>;
    /**
     * Fetch a channel's webhooks
     * @requires `TextChannel`, `Group`
     * @returns Webhooks
     */
    fetchWebhooks(): Promise<import("./ChannelWebhook.js").ChannelWebhook[]>;
    /**
     * Edit a channel
     * @param data Changes
     */
    ...
    fetchMessagesWithUsers(params?: Omit<(APIRoutes & {
        ...
        messages: Message[];
        users: import("./User.js").User[];
        members: import("./ServerMember.js").ServerMember[] | undefined;
    }>;
    /**
     * Search for messages
